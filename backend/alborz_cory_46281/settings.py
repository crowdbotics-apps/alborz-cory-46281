"""
Django settings for alborz_cory_46281 project.
...
ROOT_URLCONF = 'alborz_cory_46281.urls'
...
WSGI_APPLICATION = 'alborz_cory_46281.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "alborz_cory_46281 API",
    "DESCRIPTION": "API documentation for alborz_cory_46281 App",
    "VERSION": "v1",
}
